...
usage: space_label.py [-h] [-s SPACECRAFT] FILE DATE DATE

positional arguments:
  FILE            The name of the IDL .sav file to analyse
  DATE            The window of days to plot, in YYYY-MM-DD format, e.g. '2004-12-1
                  2004-12-31' for December 2004. The data will be scrolled through
